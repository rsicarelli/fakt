...
package dev.rsicarelli.ktfake.compiler.irnative.integration

import dev.rsicarelli.ktfake.compiler.irnative.analysis.*
import dev.rsicarelli.ktfake.compiler.irnative.types.KotlinTypeMapper
...
class SimpleIrNativeIntegrationTest {
    ...
    fun `GIVEN custom types WHEN registering mappings THEN should use custom generators`() {
        ...
        typeMapper.registerCustomTypeMapping("com.example.User") { _ ->
            dev.rsicarelli.ktfake.compiler.irnative.types.DefaultValueExpression.Constructor(
                "User",
