 ...
 *
 * Following GIVEN-WHEN-THEN pattern for cross-compilation caching feature. Tests verify that FIR
 * metadata can be serialized/deserialized for KMP caching.
 */
                ...
                interfaces =
                    listOf(
                        SerializableFakeInterface(
                            ...
                            packageName = "com.example",
                            typeParameters =
                                listOf(SerializableTypeParameterInfo("TValue", emptyList())),
                            properties = emptyList(),
                            functions =
                                listOf(
                                    SerializableFunctionInfo(
                ...
                interfaces =
                    listOf(
                        SerializableFakeInterface(
                            ...
                            inheritedProperties =
                                listOf(SerializablePropertyInfo("parentProp", "Int", true, false)),
                            inheritedFunctions =
                                listOf(
                                    SerializableFunctionInfo(
                                        name = "parentMethod",
                    ...
                    classes =
                        listOf(
                            SerializableFakeClass(
                                ...
                                typeParameters = emptyList(),
                                abstractProperties =
                                    listOf(SerializablePropertyInfo("id", "Long", false, false)),
                                openProperties =
                                    listOf(SerializablePropertyInfo("name", "String", true, true)),
                                abstractMethods =
                                    listOf(
                                        SerializableFunctionInfo(
                                            name = "save",
        ...
        val interfaces =
            (1..5).map { i ->
                SerializableFakeInterface(
                    ...
                    packageName = "com.example",
                    typeParameters =
                        if (i % 2 == 0) listOf(SerializableTypeParameterInfo("T", emptyList()))
                        else emptyList(),
                    properties = listOf(SerializablePropertyInfo("prop$i", "String", false, false)),
                    functions =
                        listOf(
                            SerializableFunctionInfo(
                                name = "method$i",
