...
class FirMetadataCacheSerializationTest {
    ...
    @Test
    fun `GIVEN valid interface metadata WHEN serialized to JSON THEN produces valid JSON`() =
        runTest {
            // GIVEN
            val cache =
                FirMetadataCache(
    ...
    @Test
    fun `GIVEN JSON string WHEN deserialized THEN restores original data`() =
        runTest {
            // GIVEN
            val original =
                FirMetadataCache(
    ...
    @Test
    fun `GIVEN complex generics WHEN roundtrip THEN preserves type parameters`() =
        runTest {
    ...
    @Test
    fun `GIVEN method-level type parameters WHEN roundtrip THEN preserves bounds`() =
        runTest {
    ...
    @Test
    fun `GIVEN inherited members WHEN serialized THEN includes all members`() =
        runTest {
    ...
    @Test
    fun `GIVEN abstract class metadata WHEN roundtrip THEN preserves abstract and open members`() =
        runTest {
            // GIVEN
            val original =
                FirMetadataCache(
    ...
    @Test
    fun `GIVEN parameters with defaults WHEN roundtrip THEN preserves default values`() =
        runTest {
            // GIVEN
            val original =
                FirMetadataCache(
    ...
    @Test
    fun `GIVEN vararg parameter WHEN roundtrip THEN preserves vararg flag`() =
        runTest {
            // GIVEN
            val original =
                FirMetadataCache(
    ...
    @Test
    fun `GIVEN cache with version WHEN roundtrip THEN preserves version`() =
        runTest {
            // GIVEN
            val original =
                FirMetadataCache(
    ...
    @Test
    fun `GIVEN cache with timestamp WHEN roundtrip THEN preserves generatedAt`() =
        runTest {
            // GIVEN
    ...
    @Test
    fun `GIVEN nested class WHEN serialized THEN uses correct classIdString format`() =
        runTest {
    ...
    @Test
    fun `GIVEN multiple interfaces WHEN roundtrip THEN preserves all interfaces`() =
        runTest {
            // GIVEN
            val original =
                FirMetadataCache(
    ...
    @Test
    fun `GIVEN typical cache WHEN serialized THEN JSON size is reasonable`() =
        runTest {
    ...
    @Test
    fun `GIVEN empty cache WHEN roundtrip THEN handles gracefully`() =
        runTest {
            // GIVEN
            val original =
                FirMetadataCache(
