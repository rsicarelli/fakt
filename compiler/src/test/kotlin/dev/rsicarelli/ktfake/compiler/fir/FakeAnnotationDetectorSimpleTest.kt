...
class FakeAnnotationDetectorSimpleTest {
    ...
    @Test
    fun `GIVEN custom parameters WHEN creating instance THEN should preserve custom values`() = runTest {
        // Given - custom parameters configuration
        val customDeps = listOf(
    ...
    @Test
    fun `GIVEN FqName patterns WHEN creating ClassId THEN should handle various package structures`() = runTest {
        ...
        testFqNames.forEach { fqNameString ->
            ...
            assertEquals(fqNameString, classId.asSingleFqName().asString(),
    ...
    @Test
    fun `GIVEN complex dependency lists WHEN creating parameters THEN should handle empty and populated lists`() = runTest {
        // Given - various dependency list scenarios
        val emptyDeps = FakeAnnotationParameters(dependencies = emptyList())
        val singleDep = FakeAnnotationParameters(dependencies = listOf(
