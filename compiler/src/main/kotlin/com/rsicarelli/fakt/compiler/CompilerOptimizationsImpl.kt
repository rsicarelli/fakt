...
internal class CompilerOptimizationsImpl(
    ...
    private fun loadPreviousSignatures() {
        ...
        try {
            val cacheFile = java.io.File(outputDir, "ktfakes-signatures.cache")
            if (cacheFile.exists()) {
                ...
                println("KtFakes: Loaded ${previousSignatures.size} cached signatures for incremental compilation")
            }
        } catch (e: Exception) {
