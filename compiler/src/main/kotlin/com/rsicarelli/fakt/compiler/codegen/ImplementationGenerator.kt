...
internal class ImplementationGenerator(
     ...
     */
    private fun generateTypeSafeDefault(function: com.rsicarelli.fakt.compiler.ir.analysis.FunctionAnalysis): String {
        val returnType =
     ...
     * Uses broad Kotlin stdlib support with exact types - no casting!
     */
    private fun generateTypeSafePropertyDefault(property: com.rsicarelli.fakt.compiler.ir.analysis.PropertyAnalysis): String {
        val propertyType =
            typeResolver.irTypeToKotlinString(property.type, preserveTypeParameters = true)
    ...
    private fun generateKotlinStdlibDefault(typeString: String): String =
        when {
            ...
            typeString.startsWith("MutableList<") ->
                extractAndCreateCollection(
                    typeString,
                    "mutableListOf",
                )

            typeString.startsWith("Set<") -> extractAndCreateCollection(typeString, "emptySet")
            typeString.startsWith("MutableSet<") ->
                extractAndCreateCollection(
                    typeString,
                    "mutableSetOf",
                )
            ...
            typeString.startsWith("Iterable<") ->
                extractAndCreateCollection(
                    typeString,
                    "emptyList",
                )
            ...
            // ✅ Sequences
            typeString.startsWith("Sequence<") ->
                extractAndCreateCollection(
                    typeString,
                    "emptySequence",
                )
