...
import dev.rsicarelli.ktfake.compiler.analysis.InterfaceAnalysis
import dev.rsicarelli.ktfake.compiler.codegen.CodeGenerator
import dev.rsicarelli.ktfake.compiler.codegen.FakeImplementation
import dev.rsicarelli.ktfake.compiler.codegen.OutputFormat
...
private class IrOutputFormat : OutputFormat<IrDeclaration> {
    ...
    override fun validate(code: IrDeclaration): dev.rsicarelli.ktfake.compiler.codegen.ValidationResult {
        // IR validation would be implemented here
        return dev.rsicarelli.ktfake.compiler.codegen.ValidationResult.Valid
    }
}
