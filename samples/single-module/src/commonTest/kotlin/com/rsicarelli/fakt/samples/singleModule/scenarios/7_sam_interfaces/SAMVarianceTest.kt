...
import com.rsicarelli.fakt.samples.singleModule.scenarios.sam_interfaces.variance.fakeBivariantMapper
import com.rsicarelli.fakt.samples.singleModule.scenarios.sam_interfaces.variance.fakeContravariantConsumer
import com.rsicarelli.fakt.samples.singleModule.scenarios.sam_interfaces.variance.fakeContravariantListConsumer
import com.rsicarelli.fakt.samples.singleModule.scenarios.sam_interfaces.variance.fakeCovariantListProducer
import com.rsicarelli.fakt.samples.singleModule.scenarios.sam_interfaces.variance.fakeCovariantProducer
import com.rsicarelli.fakt.samples.singleModule.scenarios.sam_interfaces.variance.fakeInvariantTransformer
    ...
    inner class BivariantMapperTests {
        ...
        fun `GIVEN BivariantMapper SAM WHEN using complex types THEN should handle variance`() {
            ...
            val mapper = fakeBivariantMapper<List<String>, Set<Int>> {
                map { list: List<String> -> list.map { it.length }.toSet() }
            }
