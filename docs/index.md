...
[![Kotlin](https://img.shields.io/badge/Kotlin-2.3.20%2B-blue)](https://kotlinlang.org)
...
- **[Call History](user-guide/usage.md#call-history-verification)** - Thread-safe call history and verification DSL
