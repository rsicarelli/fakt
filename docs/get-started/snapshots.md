...
The current snapshot version is **`1.0.0-beta13-SNAPSHOT`**.
...
plugins {
    ...
    id("com.rsicarelli.fakt") version "1.0.0-beta13-SNAPSHOT"
}

dependencies {
    // The @Fake annotation.
    implementation("com.rsicarelli.fakt:annotations:1.0.0-beta13-SNAPSHOT")
